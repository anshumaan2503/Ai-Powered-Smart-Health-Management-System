          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Free health guidance powered by AI</p>
              </div>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {quickQuestions.map((question, index) => (
                  <button
                    ...
                    className="text-left p-2 text-sm text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded border border-blue-200 hover:border-blue-300 transition-colors"
                  >
                    {question}
                  </button>
                ))}
            ...
            <div className="flex space-x-2">
              <div className="flex-1">
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none bg-white text-gray-900 placeholder-gray-500"
                  rows={2}
                  disabled={isLoading}
                />
              </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <p className="text-sm text-gray-600">Get general health advice, wellness tips, and symptom information from our AI assistant</p>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <p className="text-sm text-gray-600">Advanced AI technology providing accurate responses to your health questions</p>
          </div>
        </div>
