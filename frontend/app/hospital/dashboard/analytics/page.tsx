...
/**
 * Render the hospital analytics dashboard with charts, overview cards, and tabbed datasets.
 *
 * Displays loading, no-data, and data states while fetching overview, appointments, patients, doctors,
 * and revenue analytics via SWR; includes period selection, overview metric cards, and tabbed views
 * for detailed charts and lists.
 *
 * @returns The dashboard JSX element containing header controls, overview cards, tab navigation, and the content panels for Overview, Appointments, Patients, Doctors, and Revenue.
 */
