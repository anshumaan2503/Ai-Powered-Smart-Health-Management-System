...
/**
 * Render the hospital dashboard UI with profile and analytics data for the logged-in hospital user.
 *
 * Fetches the hospital profile and a 30-day analytics overview, reads the logged-in user from localStorage,
 * and redirects to /hospital/login when the user is missing or the profile request is unauthorized.
 * While profile data is loading it renders a centered loading spinner; when data is available it renders
 * hospital information, quick stats, quick actions, recent activity, and a system overview.
 *
 * @returns The dashboard JSX for an authenticated hospital user, or `null` while redirecting or when required data is absent.
 */
