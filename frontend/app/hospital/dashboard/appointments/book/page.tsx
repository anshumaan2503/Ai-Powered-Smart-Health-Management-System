...
/**
 * Page component that implements a two-step "Select Patient" → "Book Appointment" workflow.
 *
 * Provides debounced patient search, a quick patient creation form, doctor selection (fetched via SWR),
 * appointment scheduling inputs (date, time, type, priority, symptoms, notes), and handlers that submit
 * new patients and appointments to the API while managing loading, success, and error state.
 *
 * @returns The page's React element rendering the two-step patient selection and appointment booking UI.
 */
